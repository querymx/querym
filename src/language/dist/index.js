import { syntaxTree, indentNodeProp, foldNodeProp, LRLanguage, LanguageSupport } from '@codemirror/language';
...
function completeGeneric(handler) {
    return (context) => {
...
function genericCompletion(handler) {
...
export { Cassandra, MSSQL, MariaSQL, MySQL, PLSQL, PostgreSQL, SQLDialect, SQLite, StandardSQL, genericCompletion, keywordCompletion, keywordCompletionSource, sql };
